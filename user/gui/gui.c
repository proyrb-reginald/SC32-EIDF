...
static void ui_init(void) {
    ...
    lv_obj_remove_flag(ui_main_panel_heappan, LV_OBJ_FLAG_SCROLLABLE);  /// Flags
    ...
    lv_obj_set_height(ui_main_bar_heapbar, 8);
    lv_obj_set_width(ui_main_bar_heapbar, lv_pct(100));
    ...
    lv_obj_set_flex_align(ui_main_panel_drawpan, LV_FLEX_ALIGN_SPACE_BETWEEN,
                          LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_START);
    lv_obj_remove_flag(ui_main_panel_drawpan, LV_OBJ_FLAG_SCROLLABLE);  /// Flags
