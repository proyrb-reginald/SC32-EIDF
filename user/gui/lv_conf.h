...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (64 * 256U)          /**< [bytes] */
...
#define LV_DRAW_LAYER_SIMPLE_BUF_SIZE  0 // (2 * 1024)
 ...
 */
#define LV_DRAW_THREAD_STACK_SIZE (380 * 4)
...
#define LV_CACHE_DEF_SIZE 0 // (12 * 256)
...
#define LV_ATTRIBUTE_LARGE_RAM_ARRAY __attribute__((aligned(4)))
...
#define LV_USE_FS_LITTLEFS 1
    ...
    #define LV_FS_LITTLEFS_LETTER 'C'  /**< Set an upper-case driver-identifier letter for this driver (e.g. 'A'). */
